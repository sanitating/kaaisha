...
/** Configuration **/
var ftpUser = process.env.FTP_USERNAME;
var ftpPassword = process.env.FTP_PASSWORD;
var ftpPort = 21;

// var ftpHost = 'tinglabs.in'; //for tinglabs
// var ftpHost = '148.72.95.193'; //for tingprojects
var ftpHost = "216.10.247.43"; //for tingtingting

var localFiles = ["./dist/**/*", "./includes/**/*", "./img/**/*", "*.php"];

// const remoteLocation = '/public_html/websites/directory_name/'; //for tinglabs
const remoteLocation = "/public_html/projects/directory_name/"; //for tingtingting & tingprojects
